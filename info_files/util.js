...
function changeScrollHeight(noNeedFoldHeight,time){
	...
	window.setTimeout(function(){
		...
		if(defaultMenuHeight != 0){
			...
			tableBodyHeight = height-tableBody[0].offsetTop-extendIndexMenuHeight-foldHeight-moreHeight-51;
			// 设置蒙版高度
			$(".bgc").height(height-tableBody[0].offsetTop-extendIndexMenuHeight-foldHeight-moreHeight);
		}
