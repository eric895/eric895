...
function OrgDialog(conf)
{
	...
	// if(isMobile()){
		url = __ctx + '/platform/system/sysUser/mobile/dialog.ht?isSingle=' + conf.isSingle;
	// }
	url=url.getNewUrl();
...
function UserDialog(conf){
	...
	//
	// if(isMobileobile()){
		conf.dialogWidth = 1000;
		conf.dialogHeight = 600;
		url = __ctx + "/platform/system/sysUser/mobile/dialog.ht?isSingle=" + conf.isSingle + "&filterRole=" + conf.filterRole;
	// }
...
function FlowUserDialog(conf){
	...
	// if(isMobile()){
		url = __ctx + "/platform/system/sysUser/mobile/dialog.ht";
		conf.dialogWidth = 1000;
		conf.dialogHeight = 600;
	// }
...
function RoleDialog(conf)
{
	...
	if(isMobile()){*/
	var url = __ctx + '/platform/system/sysUser/mobile/dialog.ht?isSingle=' + conf.isSingle;
	// }
	url=url.getNewUrl();
