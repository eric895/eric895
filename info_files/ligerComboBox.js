...
(function ($)
{
    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            //下拉框
            g.selectBox = $('<div class="l-box-select" style="z-index:99999;"><div class="l-box-select-inner"><table cellpadding="0" cellspacing="0" border="0" class="l-box-select-table"></table></div></div>');
...
//                g._toggleSelectBox(g.selectBox.is(":visible"));
            ...
            }).focus(function ()
            {
                ...
                // by byq 设置下拉框的宽度
                var width = $(".l-text-combobox input[name='"+this.name+"']").width();
            	g.selectBox.width(width+7);
